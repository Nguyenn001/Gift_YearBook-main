document.addEventListener('DOMContentLoaded', () => {
    ...
    const members = [
        { name: 'Việt Anh', nickname: 'Peace', quote: 'Thanh xuân như một tách trà...', img: 'style/img/ThanhVien/VietAnh.jpg', hobbies: 'Đá bóng, Chơi game', message: 'Mãi là bạn thân nhé!' },
        { name: 'Ngọc Quân', nickname: 'QuÂn ximi:)', quote: 'Học không chơi đánh rơi tuổi trẻ.', img: 'style/img/ThanhVien/NgocQuan.jpg', hobbies: 'Trải nghiệm 📱 tàu', message: 'Chơi đi mai sau ko có mà chơi đâu.' },
        { name: 'Anh Tuấn', nickname: 'Goodwill', quote: 'Sống trọn từng phút giây.', img: 'style/img/ThanhVien/AnhTuan.jpg', hobbies: 'Đọc sách, Chơi game', message: 'Thời gian sẽ lấy đi tất cả nhưng thờ gian đẹp nhất của bản thân sẽ sông mãi trong chính bản thân mình . Mong răng bản thân dù có ra sao, nhìn vào chính mình nơi tuổi 18 này bạn cs thể thấy mình trẻ hoá lại để tiếp tục con đường mà mình đã chọn 🥰.' },
        { name: 'Thái Đạt', nickname: 'Đạt Vân"', quote: 'Luôn là chính mình.', img: 'style/img/ThanhVien/ThaiDat.jpg', hobbies: 'Chơi thể thao', message: 'Lớp thành công nhé!.' },
        { name: 'Thu Hà', nickname: 'Hà "Thỏ"', quote: 'Luôn là chính mình.', img: 'style/img/ThanhVien/ThuHa.jpg', hobbies: 'Du lịch', message: 'Thương lớp mình lắm.' },
        { name: 'Thu Hoài', nickname: 'Hannli', quote: 'Ngày mai sẽ tốt hơn.', img: 'style/img/ThanhVien/ThuHoai.jpg', hobbies: 'Du lịch, Xem phim', message: 'Đừng quên mình nhé.' },
